...
class CFG:
    ...
    # ================== model cfg =================
    ckpt = "/content/drive/MyDrive/Scrolls/ckpts/Vesuvius_S2_T21/Training_S2_T21_E5/Vesuvius_S2_T21-models/S-TimeSformer_T21_E5_size=64_S1_20230515162442_epoch=6.ckpt"
    backbone = 'S-TimeSformer'
    in_chans = 26
    load_chans = 33
    avg_n = 0
    scale_factor = 1
