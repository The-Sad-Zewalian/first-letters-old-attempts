...
class CFG:
    ...
    start_idxs =    {"S5_20241030152030":17,    "S5_20241108111522":12,    "S5_20241102125650":17,    "S1_20230929220920":12,    "S4_20231210132040":12,    "S1_20240110113230":39,      "S3_20240618142020":12,    "S3_20240716140050":12,    "S3_20240712074250":17,    "S1_20231004222109":17,      'S1_20230515162442':12,      '20230517214715':17,    '20230422011040':17,    '20230422213203':17,    '20230426114804':17,    '20230522182853':17,    '20230709155141':17,    '20230801194757':17,    '20240516205750':12,    '20230509173534':17}
    ...
    # ================== model cfg =================
    ckpt = "/content/drive/MyDrive/Scrolls/ckpts/Vesuvius_S2_T22/Training_S2_T22_E9/Vesuvius_S2_T22-models/TransformerUNet_T22_E9_size=64_S1_20230515162442_epoch=5.ckpt"
    backbone = 'TransformerUNet'
    in_chans = 36
    load_chans = 42
    avg_n = 0
    scale_factor = 1
    ...
    #CLAHE = A.Compose([A.CLAHE(clip_limit=(1, 16), tile_grid_size=(8, 8), p=1)])
    ...
    rotate = A.Compose([A.Rotate(10, p=1)])
...
def read_image_mask(fragment_id, start_idx=17, end_idx=43):
    ...
    if CFG.TRAIN_ON_DIFF:
      ...
      for i in idxs:
        ...
        image = (image0*0.5 + abs(image0 - image1p)*0.5)
                ...
                for yi in range(0, CFG.tile_size, CFG.size):
                    for xi in range(0, CFG.tile_size, CFG.size):
                        ...
                        if fragment_id!=CFG.valid_id:
                            if not (np.all(label_mask[a:a + CFG.tile_size, b:b + CFG.tile_size]<0.5)):
...
# Create the model
model = Inkur(pred_shape=pred_shape)
