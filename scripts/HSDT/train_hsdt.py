...
class CFG:
    ...
    start_idxs =    {"S1_20230929220920":17,    "S4_20231210132040":0,      "S3_20240618142020":17,    "S3_20240716140050":0,    "S3_20240712074250":17,    "S1_20231004222109":17,      'S1_20230515162442':0,      '20230517214715':17,    '20230422011040':17,    '20230422213203':17,    '20230426114804':17,    '20230522182853':17,    '20230709155141':17,    '20230801194757':17,    '20240516205750':0,    '20230509173534':17}
    ...
    # ================== model cfg =================
    ckpt = "/content/drive/MyDrive/Scrolls/ckpts/Vesuvius_S2_T18/Training_S2_T18_E1/Vesuvius_S2_T18-models/Bare-HSDT_T18_E1_size=64_S1_20230515162442_epoch=0.ckpt"
    backbone = 'resnet3d'
    in_chans = 31
...
class RegressionPLModel(pl.LightningModule):
    def __init__(self, pred_shape, size=256, with_norm=False, total_steps=780):
        ...
        self.loss_func3 = nn.MSELoss() #nn.SmoothL1Loss(reduction='sum', beta=0.5)
...
trainer = pl.Trainer(
    ...
    callbacks=[ModelCheckpoint(filename=f'Bare-HSDT_T{CFG.trial_no}_E{CFG.exp_no}_size={CFG.size}_{CFG.valid_id}_'+'{epoch}', dirpath=CFG.model_dir, monitor='train/total_loss', mode='min', save_top_k=3)]
)
