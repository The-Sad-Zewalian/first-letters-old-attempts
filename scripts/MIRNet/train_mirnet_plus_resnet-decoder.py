...
class CFG:
    ...
    # ================== model cfg =================
    ckpt = "/content/drive/MyDrive/Scrolls/ckpts/Vesuvius_S2_T18/Training_S2_T18_E6/Vesuvius_S2_T18-models/MIRNet+RESNet-Decoder_T18_E6_size=64_S1_20230515162442_epoch=3.ckpt"
    backbone = 'MIRNet+RESNet-Decoder'
    in_chans = 26
    classes = 4
