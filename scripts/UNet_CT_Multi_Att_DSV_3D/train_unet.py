...
class CFG:
    ...
    fragments =     ["S1_20230929220920",       "S4_20231210132040",       "S1_20240110113230",         "S3_20240618142020",       "S3_20240716140050",       "S3_20240712074250",       "S1_20231004222109",         'S1_20230515162442',         '20230517214715',       '20230422011040',       '20230422213203',       '20230426114804',       '20230522182853',       '20230709155141',       '20230801194757',          '20240516205750',   '20230509173534']
    start_idxs =    {"S1_20230929220920":17,    "S4_20231210132040":17,    "S1_20240110113230":39,      "S3_20240618142020":17,    "S3_20240716140050":17,    "S3_20240712074250":17,    "S1_20231004222109":17,      'S1_20230515162442':17,      '20230517214715':17,    '20230422011040':17,    '20230422213203':17,    '20230426114804':17,    '20230522182853':17,    '20230709155141':17,    '20230801194757':17,    '20240516205750':17,    '20230509173534':17}
    reversed_load = {"S1_20230929220920":False, "S4_20231210132040":False, "S1_20240110113230":False,   "S3_20240618142020":False, "S3_20240716140050":False, "S3_20240712074250":False, "S1_20231004222109":False,   'S1_20230515162442':False,   '20230517214715':False, '20230422011040':False, '20230422213203':False, '20230426114804':False, '20230522182853':False, '20230709155141':False, '20230801194757':False, '20240516205750':False, '20230509173534':False}
    flipped =       {"S1_20230929220920":False, "S4_20231210132040":False, "S1_20240110113230":False,   "S3_20240618142020":False, "S3_20240716140050":False, "S3_20240712074250":False, "S1_20231004222109":False,   'S1_20230515162442':False,   '20230517214715':False, '20230422011040':False, '20230422213203':False, '20230426114804':False, '20230522182853':False, '20230709155141':False, '20230801194757':False, '20240516205750':False,' 20230509173534':False}

    # ================== model cfg =================
    ckpt = None
    backbone = 'Unet-CT-Multi-Att-DSV'
    in_chans = 26
    load_chans = 32
    avg_n = 0
    scale_factor = 1
                ...
                for yi in range(0, CFG.tile_size, CFG.size):
                    for xi in range(0, CFG.tile_size, CFG.size):
                        ...
                        if fragment_id!=CFG.valid_id:
                            if not np.all(label_mask[a:a + CFG.tile_size, b:b + CFG.tile_size]<0.05):
...
class CustomDataset(Dataset):
    ...
    def TriForce(self, image, label):
        ...
        #data = self.transform(image=image, image0=image_diffs, image1=image_edges, image2=image_reversed, image3=image_avg, mask=label)
        ...
        #data = self.transform(image=image, image0=image_reversed, mask=label)
        #image = torch.cat([data['image'].unsqueeze(0), data['image0'].unsqueeze(0)], dim=0)
    ...
    def __getitem__(self, idx):
        ...
        if self.xyxys is not None:
            ...
            if self.transform:
                image, label = self.TriForce(image, label)
...
class RegressionPLModel(pl.LightningModule):
    def __init__(self, pred_shape, size=256, total_steps=780):
        ...
        self.unet_norms5 = unet_CT_multi_att_dsv_3D(in_channels=2, n_classes=1, is_batchnorm=False)
...
if CFG.ckpt:
  ...
  model = RegressionPLModel.load_from_checkpoint(CFG.ckpt, torch_dtype=torch.float16)
else:
