...
class RegressionPLModel(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        wandb_logger.log_image(key="masks_2", images=[np.clip(self.mask_pred_2, 0, 1)], caption=["probs_2"])
...
trainer = pl.Trainer(
    ...
    callbacks=[ModelCheckpoint(filename=f'{CFG.backbone}_T{CFG.trial_no}_E{CFG.exp_no}_size={CFG.size}_{CFG.valid_id}_'+'{epoch}', dirpath=CFG.model_dir, monitor='train/total_loss', mode='min', save_top_k=2)]
)
